...
RUN \
 ...
 echo "UpdateMethod=docker\nBranch=${SONARR_BRANCH}\nPackageVersion=${VERSION}\nPackageAuthor=linuxserver.io\nPackageGlobalMessage=Error: You are running an outdated docker image tag, please refer to the linuxserver/sonarr readme for valid tags" > /app/sonarr/package_info && \
